...
export function prepareEnvironmentVariables(source: string, destination: string) {
  ...
  mainJsContent = mainJsContent.replace('REPLACE_AZURE_CLIENT_ID', aiConfig.azure.clientId);

  // Replace the REPLACE_AZURE_TENANT_ID with rwtConfig.azure.tenant
  mainJsContent = mainJsContent.replace('REPLACE_AZURE_TENANT_ID', aiConfig.azure.tenantId);

  // Replace the REPLACE_AZURE_SPEECH_KEY
  mainJsContent = mainJsContent.replace('REPLACE_AZURE_SPEECH_KEY', aiConfig.speech.key);

  // Replace the REPLACE_AZURE_SPEECH_REGION
  mainJsContent = mainJsContent.replace('REPLACE_AZURE_SPEECH_REGION', aiConfig.speech.region);
