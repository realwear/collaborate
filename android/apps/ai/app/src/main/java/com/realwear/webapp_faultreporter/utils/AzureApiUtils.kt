...
object AzureApiUtils {
    ...
    fun handleApiToken(clientId: String, tenantId: String, deviceCode: String, scope: String): WebResourceResponse {
        val formData = HashMap<String, String>()
        formData[FORM_CLIENT_ID] = clientId
        formData[FORM_SCOPE] = "$scope $OPENID_SCOPES"
    ...
    fun handleApiRefresh(clientId: String, tenantId: String, refreshToken: String, scope: String): WebResourceResponse {
        // handle exceptions
        val formData = HashMap<String, String>()
        formData[FORM_CLIENT_ID] = clientId
        formData[FORM_SCOPE] = "$scope $OPENID_SCOPES"
